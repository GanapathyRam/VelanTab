<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NonICSOrders.aspx.cs" Inherits="VV.Web.Views.NonICSOrders" %>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-12" style="padding-bottom: 15px;">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" ID="ProdOrderNumber" CssClass="form-control" Style="width: 20%;" />
                                ...
                                <asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="BodyHeatNo">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtBodyHeatNo" MaxLength="10" Width="90px" runat="server" Text='<%# Eval("BodyHeatNo") %>'></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="false" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="BonnetHeatNo">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtBonnetHeatNo" MaxLength="10" Width="90px" runat="server" Text='<%# Eval("BonnetHeatNo") %>'></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="false" />
                                        </asp:TemplateField>
