...
{
    public partial class ICSOrders : System.Web.UI.Page
    {
        ...
        protected void Submit(object sender, EventArgs e)
        {
            ...
            try
            {
                string prodOrderNo = Convert.ToString(ProdOrderNo.Text.Trim());

                DBUtil _dbObj = new DBUtil();

                DataSet ds = _dbObj.GetICSOrdersDetails(prodOrderNo);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                foreach (GridViewRow row in GridView2.Rows)
                {
                    ...
                    {
                        string ProdOrderNumber = Convert.ToString(ProdOrderNo.Text.Trim());
                        ...
                        _dbObj.UpdateICSOrdersDetails(ProdOrderNumber, BodyHeatNo, BodyRTNo, BonnetHeatNo, BonnetRTNo, WedgeHeatNo, WedgeRTNo, PipeHeatNo, PipeRTNo, Bonnet2HeatNo, Bonnet2RTNo, ActuatorSerialNo);
            ...
            {
                LogError(ex, "Exception from update ICSOrders screen");
            }
        }
